...
- Wrote SQL queries to support common lookups (type effectiveness, move details, stat comparisons)  
...
- Modeled game elements (rooms, items, NPCs, actions) as reusable objects  
